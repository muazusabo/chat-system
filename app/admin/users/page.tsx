    ...
    <div className="min-h-screen bg-[var(--neu-bg)]" style={{ fontFamily: 'Poppins, sans-serif' }}>
      <div className="mx-auto max-w-6xl px-5 py-8">
        ...
        {isLoading ? (
            ...
            {data.users.map((u) => {
              ...
              return (
                <div key={u.id} className={`rounded-2xl bg-[var(--neu-bg)] p-5 ${raised}`}>
                    ...
                    <span
                      className={`rounded-full px-2 py-0.5 text-[10px] font-bold ${
                        u.role === 'ADMIN'
                          ...
                          : 'bg-[var(--neu-card-alt)] text-[var(--neu-text-secondary)]'
                      }`}
                    >
                      {u.role}
                    </span>
                  ...
                  {/* Actions — separate row, bottom of card */}
                  {hasActions && (
                    <div className="mt-4 flex flex-wrap gap-2 border-t border-[var(--neu-card-alt)] pt-4">
                      {!u.isDeleted && (
                        <>
                          {u.isBlocked ? (
                            <button
          ...
          <div
            className={`flex flex-col items-center justify-center gap-2 rounded-2xl bg-[var(--neu-bg)] px-6 py-16 text-center ${raised}`}
          >
